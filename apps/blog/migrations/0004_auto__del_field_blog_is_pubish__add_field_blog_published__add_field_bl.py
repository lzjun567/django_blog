...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Blog.is_pubish'
        db.delete_column(u'blog_blog', 'is_pubish')
        ...
        db.add_column(u'blog_blog', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Blog.is_pubish'
        db.add_column(u'blog_blog', 'is_pubish',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        ...
        db.delete_column(u'blog_blog', 'is_public')
